...
\begin{figure}
\center
\includegraphics[width=15.2cm, height=9.0cm]{henshin_conflict_model}
\caption{Henshin Class Model Map}\label{fig:conflict_model}
\end{figure}
\begin{figure}
\center
\includegraphics[width=15.cm, height=17.0cm]{henshin_conflict_rule}
...
\begin{figure}
\center
\includegraphics[width=8.2cm, height=4.6cm]{henshin_conflict_cda_result}
